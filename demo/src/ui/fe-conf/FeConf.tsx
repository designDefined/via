...
import { Main, Section, Div, H1, Strong, H3, H5, H4, Ul, Li, Img, P, Ol, H2, Span } from "@flexive/core";

export default function FeConf() {
  return (
    <Main
      f={{
    ...
    >
      <Section f={{ spacing: [0, 200] }}>
        <Div f={{ flex: [], flow: ["column", "nowrap", "end"] }}>
          <H1>
            <Strong>VIA:</Strong>
          </H1>
          <H1>나만의</H1>
          <H1 f={{ flow: ["row", "nowrap"] }}>
            <Strong>리액트 아키텍쳐</Strong>를
          </H1>
          <H1>찾아서</H1>
        </Div>
        <Div f={{ flow: ["row", "nowrap", "center", "space-between"] }}>
          <H3 f={{ flow: ["row", "nowrap"], spacing: [0, 12] }}>
            <Strong>박준영</Strong>
            designDefined
          </H3>
          <H5>FEConf 2024 Lightning Talk</H5>
        </Div>
        <Div f={{ spacing: ["240px 0"] }}>
          <H3>viajs.vercel.app</H3>
        </Div>
      </Section>
      <Section f={{ flex: [0, 0, "200px"], flow: ["row", "wrap", "center", "center"], spacing: [120] }}></Section>
      <Section f={{ spacing: [80, 64] }}>
        <Title title="발표자" />
        ...
        <Ul>
          ...
          <Div f={{ flow: ["row", "wrap", "center"], spacing: [20, 80] }}>
      ...
      <Section f={{ spacing: [80, 64] }}>
        ...
        <Div className="bordered" f={{ flow: ["row", "wrap", "center", "center"], spacing: ["120px 80px", 40] }}>
          <H4>
            <Strong>MVC?</Strong>
          </H4>
          <H4>
      ...
      <Section f={{ spacing: [80, 64] }}>
        ...
        <Div className="bordered" f={{ spacing: ["40px 80px"] }}>
          <Ul className="pros">
            <Li>넓은 생태계와 호환성</Li>
      ...
      <Section f={{ spacing: [80, 64], align: ["center"] }}>
...
function Title({ title, subTitle }: { title: string; subTitle?: string }) {
  return (
    <H3 f={{ flow: ["row", "wrap"], spacing: ["0 0 24px 0"] }}>
      <Strong>{title}</Strong>
      <Span>{subTitle}</Span>
    </H3>
  );
...
function Chapter({ title }: { title: string }) {
  return (
    <Div f={{ flow: ["column", "wrap", "center", "center"], spacing: ["160px 0"] }}>
      <H2>{title}</H2>
    </Div>
  );
}
